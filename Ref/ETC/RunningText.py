...
#     num = num + 1
#     label_var.set(roll_text[0:num]) # Edit: changed roll_text to message
#     root.after(delay, scroll)
  

# message = 'This_message_should_be_scrolling_left_to_right.'
# scroll()
# label.pack()
# root.mainloop()
...
pg.mixer.music.load("Ref/ETC/The Avengers.mp3")
