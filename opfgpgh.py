...
# the_input1 = tkinter.Entry(screen)
# the_input1.grid(row=1, column=2)

# label1 = tkinter.Label(screen, text="")
# label1.grid(row=3, column=2)

# button1_Write = tkinter.Button(screen, text = "Send to file:", width = 10 ,command = lambda: USER_write_File(the_input)).grid(row=10, column=1)
# button2_Write = tkinter.Button(screen, text = "Send to file:", width = 10, command = lambda: ADMIN_write_File(the_input1)).grid(row=10, column=2)
...
the_input = tkinter.Entry(root)
the_input.place(x=0, y=400)

the_input1 = tkinter.Entry(root)
the_input1.place(x=200, y=400)

label1 = tkinter.Label(root, text="")
label1.place(x=0, y=480)

button1_Write = tkinter.Button(root, text = " U Send to file:", width = 10 ,command = lambda: USER_write_File(the_input)).place(x=0, y=420)
button2_Write = tkinter.Button(root, text = "A Send to file:", width = 10, command = lambda: ADMIN_write_File(the_input1)).place(x=200, y=420)
